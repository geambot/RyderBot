...
import config
from RyderBot import Carbon, YouTube, app
from RyderBot.core.call import RyderBot
from RyderBot.misc import db
from RyderBot.utils.database import (add_active_chat,
                                       add_active_video_chat,
                                       is_active_chat,
                                       is_video_allowed, music_on)
from RyderBot.utils.exceptions import AssistantErr
from RyderBot.utils.inline.play import (stream_markup,
                                          telegram_markup)
from RyderBot.utils.inline.playlist import close_markup
from RyderBot.utils.pastebin import RyderBotbin
from RyderBot.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await RyderBot.force_stop_stream(chat_id)
