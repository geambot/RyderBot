...
from RyderBot import LOGGER, app, userbot
from RyderBot.core.call import RyderBot
from RyderBot.plugins import ALL_MODULES
from RyderBot.utils.database import get_banned_users, get_gbanned
...
async def init():
    ...
    await userbot.start()
    await RyderBot.start()
    try:
        await RyderBot.stream_call(
